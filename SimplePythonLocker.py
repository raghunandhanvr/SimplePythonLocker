...
PASSWORD = "set your password"                                                  #Set your password here

connect = raw_input("Password : \n")
...
if connect == PASSWORD:
    ...
    while True:
        print("\n"+ "*"*15)                                                     #Commands to add or open files from locker
        print("Commands:")
        ...
        if input_ == "o":
            # open the file
            file_type = raw_input("What is the filetype of the file you want to open? The Formats are txt, png, dart, java, jpg, jpeg\n")
